    ...
    return (
        <header className="h-[auto] py-[12px] px-[32px] hidden lg:flex items-center justify-between sticky top-0 z-40 bg-neutral-0/80 backdrop-blur-md">
            ...
            <div className="flex items-center gap-[24px]">
                ...
                <button className="bg-neutral-1000 text-neutral-0 px-[16px] py-[12px] rounded-full flex items-center gap-[8px] hover:opacity-90 transition-all shadow-md active:scale-95 group">
